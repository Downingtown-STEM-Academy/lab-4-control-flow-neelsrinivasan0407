 ...
 */
var questionsCorerct: Double = 15.0
let totalPoints:Double = 20.0
if questionsCorerct/totalPoints >= 0.70 {
    print("You passed, but you should could consider studying a bit more.")
}
else if questionsCorerct/totalPoints > 0.90 {
    print("Great job! Move on to the next topic.")
}
else if questionsCorerct/totalPoints < 0.70 {
